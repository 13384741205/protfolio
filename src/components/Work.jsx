...
const PROJECTS = [
  {
    title: 'The Seasider Seafood Restaurant',
    category: 'Website UI Design · Blackpool',
    year: '2024',
    image: 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=1200&q=80',
    color: '#1a2a3a',
  },
  {
    title: 'Blackpool Grill Steakhouse',
    category: 'Website UI Design · Blackpool',
    year: '2024',
  ...
  },
  {
    ...
    category: 'UI Design · E-commerce Platform',
    year: '2022',
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&q=80',
    color: '#1b2a1a',
  },
  {
    title: 'Italiano Italian Restaurant',
    category: 'Website UI Design · Blackpool',
    year: '2023',
